...
export const AboutSection = () => {
  ...
  const techStack = [
    { category: "Programming", items: ["DSA,C/C++", "JavaScript", "OOPS", "Python","SQL","Data Analysis"] },
    { category: "Development", items: ["React", "TailwindCSS","HTML","CSS","JavaScript","Project Management"] },
    { category: "Tools", items: ["Netlify", "Google Colab", "Vercel", "Firebase", "Vs Code","Github"] }
  ];

  const features = ["Frontend expertise", "Clean, maintainable code", "Performance optimization", "Project Management", "Team Collaboration", "Timely delivery"];

  const socialLinks = [
    { icon: <Github className="h-5 w-5" />, href: "https://github.com/SaumyaMishra6424" },
    { icon: <Linkedin className="h-5 w-5" />, href: "www.linkedin.com/in/saumya-mishra-75ab86272" },
    { icon: <Mail className="h-5 w-5" />, href: "mailto:smsaumya07092002@gmail.com" }
  ];

  const tabContent = {
    personal: "Passionate about creating web apps  that solve real problems and deliver meaningful user experiences. I enjoy experimenting with new technologies,  constantly pushing myself to stay current in a fast-evolving tech landscape.",
    professional: "I’ve worked on e-commerce solutions, translating business needs into responsive, user-friendly interfaces that drive engagement and transactions. Alongside development, I’ve also worked on SEO optimization and performance improvements, strengthening both visibility and Core Web Vitals for real users.",
    approach: "I believe in clean code, thorough testing, and user-centered design. My process emphasizes collaboration and continuous improvement,balancing technical excellence with practical usability to create solutions that truly make a difference."
  };
      ...
      <div className="container mx-auto max-w-7xl relative">
        ...
        <div className="text-center mb-16 md:mb-20 px-2 sm:px-6">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
           Creating web apps that combine <span className="text-primary font-semibold">innovation</span>, <span className="text-primary font-semibold">scalability</span>, and <span className="text-primary font-semibold">elegance</span>
          </p>
        </div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-2xl transition-all duration-500 group-hover:border-primary/40 group-hover:scale-105 md:group-hover:scale-110 relative">
                      <img src={profileImg} alt="Saumya Mishra" className="w-full h-full object-cover" />
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Saumya Mishra</h2>
