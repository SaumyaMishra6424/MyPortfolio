...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/xojwzjng', {
        method: 'POST',
        headers: {
      ...
      toast({
        ...
        description: "Please try again or email me directly at smsaumya07092002@gmail.com",
        variant: "destructive"
      });
    } finally {
                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/saumya-mishra-75ab86272",
                  },
                  {
                    icon: Twitter,
                    label: "Twitter",
                  ...
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/SaumyaMishra6424",
                  },
                  {
                    icon: Instagram,
                    label: "Instagram",
