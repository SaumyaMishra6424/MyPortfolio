...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://linkedin.com/in/saumya-mishra-75ab86272", label: "LinkedIn" },
    
    { icon: <Github size={18} />, href: "https://github.com/SaumyaMishra6424", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "smsaumya07092002@gmail.com", href: "mailto:smsaumya07092002@gmail.com" },
    { icon: <Phone size={16} />, text: "+91 6386865674", href: "tel:+916386865674" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Saumya</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
               Frontend developer focused on clean design and smooth user experiences.
              </p>
          ...
          >
            <div>
              <p>© {currentYear} Saumya. All rights reserved.</p>
            </div>
