...
import FakeNews from "../assets/icons/FakeNews.png";
...
const projects = [
  ...
  category: "FinTech",
  description: "Personal finance management web app with secure authentication and AI-powered expense insights.",
  image: PersonalFinanceTracker,
  tags: ["React", "Firebase Auth", "TailwindCSS", "Recharts", "Cohere API"],
  demoUrl: "https://ai-powered-personal-finance-tracker-gules.vercel.app?_vercel_share=BldSCid3E47HPk19Jc0Q9uulyMyZFUkS",
  githubUrl: "https://github.com/SaumyaMishra6424/AI-Powered-Personal-Finance-Tracker",
  featured: true,
...
},
{
  ...
  demoUrl: "#",
  githubUrl: "https://github.com/SaumyaMishra6424/FineDineExpress",
  featured: true,
...
},
{
  ...
  demoUrl: "#",
  githubUrl: "https://github.com/SaumyaMishra6424/FakeNewsDetectionProject",
  featured: true,
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative">
        ...
        >
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            A collection of projects I've built to showcase my skills in frontend development and modern web technologies.
          </motion.p>
        </motion.div>
        ...
        >
          <div className="bg-background border border-border rounded-2xl p-12 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <motion.a
                href="https://github.com/saumyamishra6424"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
