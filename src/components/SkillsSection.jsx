...
const skills = [
  ...
  { name: "Python", level: 85, category: "Programming", icon: "python" },
  { name: "C/C++", level: 80, category: "Programming", icon: "cpp" },
  { name: "SQL", level: 75, category: "Programming", icon: "sql" },
  { name: "JavaScript", level: 90, category: "Programming", icon: "javascript" },


  { name: "HTML5", level: 95, category: "Development", icon: "html" },
  { name: "CSS3", level: 90, category: "Development", icon: "css" },
  { name: "JavaScript", level: 90, category: "Development", icon: "javascript" },
  { name: "React", level: 90, category: "Development", icon: "react" },
  ...
  { name: "SQL", level: 75, category: "Tools", icon: "sql" },
  
];

const categories = [
  { id: "all", label: "All Skills", color: "bg-gradient-to-r from-purple-500 to-pink-500" },
  { id: "Programming", label: "Programming", color: "bg-gradient-to-r from-blue-500 to-cyan-500" },
  { id: "Development", label: "Development", color: "bg-gradient-to-r from-green-500 to-emerald-500" },
